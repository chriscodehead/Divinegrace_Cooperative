        ...
        <div class="uk-width-3-3@m">
            <div data-uk-grid="" class="uk-grid">
                <div class="uk-width-1-2@s uk-width-2-3@m uk-first-column">
                    <h1 class="uk-margin-remove myWhite">FAQs</h1>
                    <p class="uk-text-lead uk-text-muted uk-margin-small-top">
                        Any Questions? We are here to answer you </p>
                </div>
                        ...
                        <div class="uk-first-column">
                            <ul class="in-faq-2 uk-accordion" data-uk-accordion="">
                                <li>
                                    ...
                                    <div class="uk-accordion-content uk-card uk-card-default uk-card-body uk-border-rounded" hidden="">
                                        <p>Yes we are officially and properly registered with the Switzerland company house our company registration number is CHE-234.929.053
</p>
                                    </div>
                                </li>
                        ...
                        <div class="uk-first-column">
                            <ul class="in-faq-2 uk-accordion" data-uk-accordion="">
                                <li>
                                    ...
                                    <div class="uk-accordion-content uk-card uk-card-default uk-card-body uk-border-rounded" hidden="">
                                        <p>You are allowed to make a deposit just once on all our investment plans except the vertex plan where you can invest with no limit.</p>
                                    </div>
                                </li>
...
<!-- Mirrored from www.crystalasset.digital/?a=faq by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Sep 2023 13:18:08 GMT -->
</html>
