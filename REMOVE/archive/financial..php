        ...
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-center">
                <div class="uk-width-4-5@m">
                    <h1 class="uk-margin-remove uk-text-center"><span class="in-highlight">Financial Planning</span></h1><br>

                    <div class="uk-inline-clip uk-transition-toggle uk-border-rounded uk-margin-top">
                        <img class="uk-transition-scale-up uk-transition-opaque" src="serv/4.jpg" alt="">
                    </div>
                    ...
                    <div class="uk-grid uk-grid-small uk-margin-top">
                        ...
                        <div class="uk-width-expand">
                            <div class="">
                                ...
                                the future,
                                or what steps need to be taken to ensure that they are.
                            </div>
                        </div>
                    </div>
            ...
            <div class="uk-child-width-1-2@m uk-flex uk-flex-middle uk-grid" data-uk-grid="">
                ...
                <div class="uk-flex uk-flex-right uk-flex-middle right-content">
                    <span class="uk-margin-large-left">
                        <a href="register" class="uk-button uk-button-secondary uk-button-large uk-border-rounded">Open your account</a>
                    </span>
                </div>
            </div>
        </div>
...
<!-- Mirrored from www.crystalasset.digital/?a=services-d4 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Sep 2023 13:19:41 GMT -->
</html>
