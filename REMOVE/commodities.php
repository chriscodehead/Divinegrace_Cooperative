        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                  <h1 class="fw-bold mb-2">Commodity  <span class="text-highlight">Market:</span> </h1>
                  <p class="lead text-muted"> Includes Gold, Silver, Crude oil, Palladium, Platinum, Copper, Nickel, and natural gas;</p>
                </div>
            </div>
