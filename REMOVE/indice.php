        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                  <h1 class="fw-bold mb-2">Index  <span class="text-highlight">Market:</span></h1>
                  <p class="lead text-muted"> Includes trading of international stock market indices such as the United States, Europe, Asia, Australia, etc;</p>
                </div>
            </div>
