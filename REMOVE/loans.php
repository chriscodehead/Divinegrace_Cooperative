        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                  <h1 class="fw-bold mb-2">Loan  <span class="text-highlight">:</span></h1>
                  <p class="lead text-muted"> When you borrow money in the form of a loan, you will need to pay back the loan amount plus interest within an amount of time. This repayment typically occurs over the life of your loan, whether that’s three years or 30 years. <br>Before you sign the agreement to get your new loan, it’s useful to understand exactly how your payment will be applied to your loan over time. Take a look.</p>
                </div>
            </div>
