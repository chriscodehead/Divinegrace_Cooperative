...
$title = $siteName.' | Real Estate Investment';
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                  <h1 class="fw-bold mb-2">Real Estate Investment   <span class="text-highlight">Market:</span></h1>
                  <p class="lead text-muted"> We are also into real estate investment and property management with a focus on U.S., U.K. multifamily, senior living and hospitality properties. We executes value add strategies and manages a national portfolio of properties on behalf of institutional investors, family offices and financial institutions. We manages its multifamily and senior living properties through a vertically integrated operations platform. We have expertise in selecting and managing attractive risk adjusted real estate investments located in major markets around the United States. As of March 31, 2019, Our’ portfolio includes approximately $1.4 billion in real estate assets. cross-trains its staff, resulting in a unique customer experience that combines the best qualities of hotel, senior living and apartment communities. We call this approach Resitality®, which serves as a competitive advantage across our diverse portfolio.
</p>
                </div>
            </div>
            ...
            <div class="row gy-md-2 gx-0 gx-lg-4">
                <div class="col-md-12 col-lg-8">
                    <div class="col d-md-flex d-lg-flex align-items-start">
                        ...
                        <div>
                            <h3 class="fw-bold">Why trade with <?php print $siteName;?>?</h3>
                            <p>Commodity trading refers to those frequently utilized in the financial investment market as industrial basic raw materials, such as gold, crude oil, nonferrous metals, steel, agricultural goods, iron ore, coal, and so on. Investors purchase and sell commodities such as gold, crude oil, and copper on the international commodity market in order to benefit on price discrepancies.</p>
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-2 mt-3 mb-3 mb-md-0 mb-lg-0 gx-0">
                                <div class="col">
                                    <ul class="fa-ul lh-lg">
                                        ...
                                        <li><span class="fa-li"><i class="fas fa-check-square text-info"></i></span>Dividends paid in cash</li>
                                    </ul>
                                </div>
                                <div class="col">
                                    <ul class="fa-ul lh-lg">
                ...
                <div class="col-12">
                    <div class="card shadow-sm border-info">
                        <div class="card-body d-lg-flex justify-content-between align-items-center p-4">
                            <h4 class="fw-bold mb-0">Get up to $600 plus 60 days of commission-free stocks</h4>
                            <a class="btn btn-info mt-2 mt-lg-0" href="accounts/register">Open an Account</a>
                        </div>
                    </div>
                </div>
            </div>
