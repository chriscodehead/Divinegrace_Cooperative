...
$title = $siteName.' | Trading Analysis';
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-2">
                  <h1 class="fw-bold mb-2">Stock  <span class="text-highlight">Market:</span></h1>
                  <p class="lead text-muted"> Includes all blue-chip stocks and high-tech companies such as Amazon, Apple, and Tesla in the states;</p>
                </div>
            </div>
