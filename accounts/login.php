...
$msg='';$msg2='';
if(isset($_GET['inc'])&&!empty($_GET['inc'])){$msg2=$_GET['inc'].'';}
if(isset($_POST['sub'])){
        ...
        <div class="row login-box">
            <div class="col-lg-6 form-section">
                <div class="form-inner">
                    ...
                    <h3 style="text-align: left; padding-top: 30px;">Sign Into Your Account</h3>
                    <form action="" enctype="multipart/form-data" method="post">
                        <input type="hidden" value="<?php if(!empty($emaillog)) print $emaillog;?>" name="emailac" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix">
                    <?php if(!empty($msg) || !empty($msg2)){?>
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <?php if(!empty($msg)){ print @$msg.'<br />';};?><?php print @$msg2;?>
        ...
        <div class="modal-content">
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" value="<?php if(!empty($email)) print $email;?>" name="emailac2" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix">
