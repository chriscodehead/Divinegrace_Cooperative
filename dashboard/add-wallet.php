...
if (isset($_POST['sub'])) {
    ...
    if (!empty($usdt)) {
        $feilds = array('usdt', 'ethereum_wallet_address', 'wallet_address');
        $value = array($usdt, $eth, $btc);
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <div class="form-label-group">
                                                                    <label class="form-label">Enter BTC wallet address <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="form-control-group">
                                                                    <input value="<?php print $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'wallet_address'); ?>" name="btc" id="btc" type="text" class="form-control form-control-lg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="nk-kycfm-content">
                                                    <div class="row g-4">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <div class="form-label-group">
                                                                    <label class="form-label">Enter ETH wallet address <span class="text-danger">*</span></label>
                                                                </div>
                                                                <div class="form-control-group">
                                                                    <input value="<?php print $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'ethereum_wallet_address'); ?>" name="eth" id="eth" type="text" class="form-control form-control-lg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
