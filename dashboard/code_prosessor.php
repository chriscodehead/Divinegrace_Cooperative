...
if(!empty($fname)&&!empty($lname)&&!empty($email)){
    //,'ethereum_wallet_address','bnb','ltc','wallet_address','perfectmoney'
    //,$btc,$pm,$eth,$bnb,$ltc
		$feilds = array('first_name','last_name','phone','address','country','sex');
		$value = array($fname,$lname,$phone,$address,$country,$sex);
