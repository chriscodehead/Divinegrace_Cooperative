                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="circla"><i class="coin ni ni-users text-warning ni-view-x2"></i></div>
                                                                </td>
                                                                <td>
                                                                    <div class="circla"><i class="coin ni ni-users text-warning ni-view-x2"></i></div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefA; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefB; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefC; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefD; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefE; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefF; ?>%</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div style="padding-top: 5px; font-size: 20px;"><?php print $siteRefG; ?>%</div>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
