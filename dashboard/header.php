        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="./" class="logo-link">
                    ...
                    <img style="width: 110px;" class="logo-dark logo-img" src="img/logo.png" srcset="../img/logo.png" alt="logo">
                ...
                <div class="nk-news-list">
                    ...
                    <a target="_blank" class="nk-news-item" href="<?php print $siteLink; ?>?ref=<?php print $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'client_username'); ?>">
                        ...
                        <div class="nk-news-text">
                            <p>Join the wining team today! <span> Start earning.</span></p>
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info  d-md-block">
                                    <?php if ($sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'account_number') == "" || $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'email_activation') == "no") { ?>
                                    ...
                                    <div class="user-name dropdown-indicator">
                                        ...
                                        <span class="text-dark"><?php print $firstname = $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'first_name'); ?> <?php print $lastname = $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'last_name'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                                <div class="user-card">
                                    <div class="user-avatar">
                                        <span><?php print strtoupper(mb_substr($firstname, 0, 1)); ?></span>
                                    </div>
                                    <div class="user-info">
                                        <span class="lead-text"><?php print $firstname; ?> </span>
