                                    ...
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-wgwh">
                                            ...
                                            <div class="nk-wgwh-title h5"> Account Wallets <small>/</small>
                                                <div class="dropdown">
                                                    <a class="dropdown-indicator-caret" data-offset="0,4" href="#" data-toggle="dropdown"><small><?php print $base_currency; ?></small></a>
                                            ...
                                            <div class="nk-wgw-inner">
                                                <a class="nk-wgw-name" href="wallets">
                                                    <div class="nk-wgw-icon is-default">
                                                        <em class="icon"><?php print $base_currency; ?></em>
                                                    </div>
