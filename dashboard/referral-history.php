                            ...
                            <div class="nk-block-head">
                                <div class="nk-block-between-md">
                                    <div class="nk-block-head-content">
                                        <div class="nk-block-head-sub"><a class="back-to" href="wallets"><em class="icon ni ni-arrow-left"></em><span>My Referrals</span></a></div>
                                        <div class="nk-wgwh">
                                            <em class="icon-circle icon-circle-lg icon"><?php print $base_currency; ?></em>
                                            <div class="nk-wgwh-title h5"> History <small>/</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <?php $select->getReferralHistory($sqli->getEmail($_SESSION['user_code']), $base_currency); ?>
