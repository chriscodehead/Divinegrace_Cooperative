...
$title = 'All Top Transaction | ' . $siteName;
$desc = '';
...
$total_pages_sql = "SELECT COUNT(*) FROM $top_up WHERE `email` = '" . $sqli->getEmail($_SESSION['user_code']) . "' ";
       ...
       <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between g-3">
         <div class="nk-block-head-content">
          <h3 class="nk-block-title page-title">Top Up Transaction History</h3>
          <div class="nk-block-des text-soft">
           <p>You have a total of <?php print $total_rows + 1; ?> transactions.</p>
          </div>
         </div>
         <div class="nk-block-head-content">
          ...
          <div class="card-inner">
           <div class="card-title-group">
            <div class="card-title">
             <h5 class="title">My Top Up Transaction History</h5>
            </div>
           </div>
          </div>
             ...
             while ($row = mysqli_fetch_assoc($sql)) { ?>
              <div class="nk-tb-item">
               ...
               <div class="nk-tb-col tb-col-lg">
                <span class="tb-lead-sub"><?php print $row['payment_id']; ?></span>
               ...
               <div class="nk-tb-col nk-tb-col-status">
                <span class="badge badge-sm badge-dim badge-outline-success d-md-inline-flex"><?php print $row['date_pay']; ?></span>
               </div>
              </div>
             <?php $a++;
             }
           ...
           <ul class="pagination justify-content-center justify-content-md-start">
            <li class="page-item <?php if ($page <= 1) {
                                  echo 'disabled';
                                                                   ...
                                                                   echo "top-up-history?page=" . ($page - 1);
                                                                  } ?>">Prev</a></li>
            <li class="page-item"><a class="page-link" href="top-up-history?page=1">1</a></li>
            <li class="page-item"><span class="page-link"><em class="icon ni ni-more-h"></em></span></li>
            <li class="page-item"><a class="page-link" href="top-up-history?page=<?php echo $total_pages; ?>">Last</a></li>
