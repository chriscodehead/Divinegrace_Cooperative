...
if (isset($_POST['sub'])) {
    ...
    $passh = $sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'password');
    $msg = $email_call->ActivateMail($email, $passh);
}
                                                    ...
                                                    <div class="card-inner">
                                                        <ul class="list list-step">
                                                            <?php if ($sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'email_activation') == 'no') {
                                                                $a = 0;
                                                                $aa = 0; ?>
                                                                <li class="list-step-current"><a data-toggle="modal" href="#myModalAC" style="color:#06C; font-size:16px;">Verify email address</a></li>
                                                            ...
                                                            if ($veri == 'Verified') {
                                                            ?>
                                                                <li class="list-step-done" style="color: gold;">KYC Verified</li>
                                                            <?php } else { ?>

                                                                <li style="color:#06C; font-size:16px;" class="list-step-current"><a href="kyc">Verify your identity (KYC)</a></li>
                                                            <?php } ?>
                                                            ...
                                                            <!-- <?php if ($sqli->getRow($sqli->getEmail($_SESSION['user_code']), 'usdt') == '') {
                                                                        $c = 0;
                                                                        $cc = 0; ?>
                                    ...
                                    <div class="card card-custom-s1 card-bordered">
                                        <div class="row no-gutters">
                                            <div class="col-lg-12" style="padding-bottom: 20px; padding-top: 20px;">
                                                <center><a href="./" class="btn btn-lg btn-primary">Get Started</a></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
