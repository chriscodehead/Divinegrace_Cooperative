...
$siteLink = 'https://omegatrixta.com/accounts/register';
$siteRegister = 'https://omegatrixta.com/accounts/register';
$siteLogin = 'https://omegatrixta.com/accounts/login';
$site = 'https://omegatrixta.com';
$domain = 'omegatrixta.com';
$siteName = $row['site_name'];
$siteEmail = "support@omegatrixta.com";
$siteEmail2 = "support@omegatrixta.com";
    ...
    public function login($email, $password, $page, $usernamefield, $passwordfield, $table)
    {
        ...
        if ($stmt->execute()) {
            ...
            if ($row['blocked_account'] == 1) {
                return 'Your Account is locked please <a style="color:#FFF;" href="mailto:support@omegatrixta.com"><u>contact support: support@omegatrixta.com</u></a>';
...
<body>
<h6><img src="https://www.omegatrixta.com/img/logo.png" /></h6>
<div style="font-size: 14px;">
<p>
Hello, ' . $name . '
</p><p>
This email contains your 2 Factor Authentication code to complete your login at omegatrixta.com.
</p>
Email: ' . $email . '<br />
...
Email: support@omegatrixta.com<br />
</p>
 </div>
</body>
</html>';
        ...
        $header .= 'From: Envato Limited <support@omegatrixta.com>' . "\r\n";
...
from this mailing list.
    ...
    ';
        $header = "MIME-Version: 1.0" . "\r\n";
        $header .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $header .= 'From: NETZONE META TRADING <support@omegatrixta.com>' . "\r\n";
        $retval = @mail($to, $subject, $message, $header);
