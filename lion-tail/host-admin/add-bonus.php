...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
		...
		<tr>
			...
			<div class="form-group">
				<label>Account Balance <?php print @$cal->selectFrmDB($user_tb,'first_name','email',$user_id);?></label><br />
			  <hr color="red">
				  <div class="col-lg-6">
					 Available Balance($): <input type="number" value="<?php print @$cal->selectFrmDB($user_tb,'main_account_balance','email',$user_id);?>" class="form-control" id="bonus" name="bonus" placeholder="0.00">
				  </div>
			  </div>
				</td>
			...
			<tr>
				...
				<input class="btn btn-primary" type="submit" name="post" value="Update Bonus" /></td>
                    ...
                    <!-- .row -->
                <div class="row">
                    <div style="display: none;" class="col-md-12 col-lg-12 col-sm-12">
                        <div class="panel">
