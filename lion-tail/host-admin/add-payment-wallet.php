...
if (isset($_POST['walletset'])) {
 ...
 $xrp = $_POST['xrp'];
 if (!empty($walt)) {
  $feilds = array('eth', 'btc', 'usdt', 'bnb', 'usdt_network', 'bch', 'xlm', 'xrp');
  $value = array($walt, $btc, $usdt, $bnb, $usdt_network, $bch, $xlm, $xrp);
       ...
       <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
        <tbody>
         ...
         <tr>
          ...
          <td>(Network) <input name="usdt_network" value="<?php print $sqli->getPaymentDetails('usdt_network'); ?>" type="text" class="form-control" placeholder="Network" />
          </td>
         </tr>
